//clang++ -Isrc -std=c++17 -march=native -pipe -O3 -Wall -Wextra -Wpedantic -o build/addhistsWj src/AddhistsWj.cxx `root-config --libs` -lm
...
void addhistsWj(const channel ch){
	// do tzq first so that tpr & tln are not null
	if(munu == ch) {NPLc = "munu";NPLds = "wjt";}
...
*/
	...
	TFile hf(("histo/BDT_" + NPLc + "__Wj.root").c_str(),"RECREATE");
	if(0<debug) std::cout<<"file created"<<std::endl;
	fbtagw->SetName(("btag_w_"   + NPLc +"__Wj").c_str());
	flp_sf->SetName(("mostSF_"   + NPLc +"__Wj").c_str());
	ftpt_w->SetName(( "ttbSF_"   + NPLc +"__Wj").c_str());
	fcmtet->SetName(("cmet_sEt_" + NPLc +"__Wj").c_str());
	fcmtpt->SetName(("cmet__pt_" + NPLc +"__Wj").c_str());
	fcmtph->SetName(("cmet_phi_" + NPLc +"__Wj").c_str());
	fmteta->SetName(( "met_sEt_" + NPLc +"__Wj").c_str());
	fmt_pt->SetName(( "met__pt_" + NPLc +"__Wj").c_str());
	ft__pt->SetName(( "ttop_pt_" + NPLc +"__Wj").c_str());
	ft_mas->SetName((     "tTm_" + NPLc +"__Wj").c_str());
	fWinvm->SetName(("W_invariant_mass_" + NPLc +"__Wj").c_str());
        ftWinm->SetName((     "tWm_" + NPLc +"__Wj").c_str());
	fev_sf->SetName((     "ev_w_"+ NPLc +"__Wj").c_str());
	fz_mas->SetName((    "zmas_" + NPLc +"__Wj").c_str());
	fzwdph->SetName((  "Z_W_Delta_Phi_" + NPLc +"__Wj").c_str());
	fzmdph->SetName(("Z_MET_Delta_Phi_" + NPLc +"__Wj").c_str());
	fwz_dr->SetName(("WZ_DeltaR_"+ NPLc +"__Wj").c_str());
	fzjdph->SetName(("Z_pair_jets_Delta_Phi_" + NPLc +"__Wj").c_str());
//	f__npl->SetName(("npl_" + NPLc +"__Wj").c_str());
        fnbjet->SetName(("nbjet_" + NPLc +"__Wj").c_str());

	fjt_pt->SetName((NPLc +"__Wj_" + "fin_jets__pt").c_str());
	fjteta->SetName((NPLc +"__Wj_" + "fin_jets_eta").c_str());
	fjtphi->SetName((NPLc +"__Wj_" + "fin_jets_phi").c_str());
	fjtmas->SetName((NPLc +"__Wj_" + "fin_jets_mas").c_str());
	flp_pt->SetName((NPLc +"__Wj_" + "lep__pt").c_str());
	flpeta->SetName((NPLc +"__Wj_" + "lep_eta").c_str());
	flpphi->SetName((NPLc +"__Wj_" + "lep_phi").c_str());
	flpmas->SetName((NPLc +"__Wj_" + "lep_mas").c_str());
	fb__pt->SetName((NPLc +"__Wj_" + "bjet__pt").c_str());
	fb_eta->SetName((NPLc +"__Wj_" + "bjet_eta").c_str());
	fb_phi->SetName((NPLc +"__Wj_" + "bjet_phi").c_str());
	fb_mas->SetName((NPLc +"__Wj_" + "bjet_mas").c_str());
